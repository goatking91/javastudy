...
public class App {
  ...
  private static void saveLessonData() {
    try (DataOutputStream out = new DataOutputStream(
        new BufferedOutputStream(new FileOutputStream("lesson.bin")))) {
  ...
  private static void saveMemberData() {
    try (DataOutputStream out = new DataOutputStream(
        new BufferedOutputStream(new FileOutputStream("member.bin")))) {
  ...
  private static void loadBoardData() {
    ...
    try {
      ...
      int length = in.readInt(); // 형식: 번호,내용,등록일,조회수
  ...
  private static void saveBoardData() {
    try (DataOutputStream out = new DataOutputStream(
        new BufferedOutputStream(new FileOutputStream("board.bin")))) {
